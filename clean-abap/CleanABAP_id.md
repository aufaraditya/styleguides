...
- [Classes](#classes)
  - [Classes: Object orientation](#classes-object-orientation)
    ...
    - [Sebaiknya  gunakana composition daripada inheritance](#prefer-composition-to-inheritance) ------------------------
    - [Jangan campur stateful dan stateless pada class yang sama](#dont-mix-stateful-and-stateless-in-the-same-class)
  - [Scope](#scope)
    - [Gunakan deklarasi Global Secara default, deklarasi local hanya pada kondisi tertentu](#global-by-default-local-only-where-appropriate)
