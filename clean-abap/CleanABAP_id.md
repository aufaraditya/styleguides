...
Guide ini diadopsi dari buku
[Robert C. Martin's _Clean Code_]
for [ABAP](https://en.wikipedia.org/wiki/ABAP).

Bagian [Cheat Sheet](cheat-sheet/CheatSheet.md) ini adalah versi yang dirancang khusus untuk dicetak
...
- [Tata Cara](#how-to)
  - [Bagaimana Cara untuk Mulai Mengikuti Clean Code](#how-to-get-started-with-clean-code)
  - [Bagaimana Refactor Kode-Kode Lama](#how-to-refactor-legacy-code)
  - [Bagaimana Cara Memeriksa Secara Otomatis](#how-to-check-automatically)
  - [Bagaimana Cara Menghubungkan dengan Guide Lain](#how-to-relate-to-other-guides)
  - [Bagaimana Cara Mengungkapkan Ketidaksetujuan](#how-to-disagree)
- [Penamaan](#names)
  - [Gunakan nama yang deskriptif](#use-descriptive-names)
  - [Sebaiknya gunakan istilah sesuai dengan ranah solusi dan ranah permasalahan](#prefer-solution-domain-and-problem-domain-terms)
  - [Gunakan kata jamak](#use-plural)
  - [Gunakan nama yang mudah untuk dieja](#use-pronounceable-names)
  - [Hindari singkatan](#avoid-abbreviations)
  - [Gunakan singkatan yang sama dimanapun](#use-same-abbreviations-everywhere)
  - [Gunakan kata benda untuk Class dan Kata Kerja untuk Methods](#use-nouns-for-classes-and-verbs-for-methods)
  - [Hindari kata yang tidak perlu seperti "data", "info", "object"](#avoid-noise-words-such-as-data-info-object)
  - [Pilih satu kata per konsep](#pick-one-word-per-concept)
  - [Gunakan nama pattern sesuai fungsinya secara benar](#use-pattern-names-only-if-you-mean-them)
  - [Hindari encodings, terutama Hungarian notation dan prefiks](#avoid-encodings-esp-hungarian-notation-and-prefixes)
- [Bahasa](#language)
  - [Perhatikan Versi Terdahulu](#mind-the-legacy)
  - [Perhatikan Performa](#mind-the-performance)
  - [Sebaiknya gunakan Object Oriented dibandingkan dengan Prosedural](#prefer-object-orientation-to-procedural-programming)
  - [Sebaiknya gunakan pengkonstruksian secara fungsional dibandingkan secara prosedural](#prefer-functional-to-procedural-language-constructs)
  - [Hindari bagian-bagian dari kode yang obsolet](#avoid-obsolete-language-elements)
  - [Gunakan design pattern secara bijak](#use-design-patterns-wisely)
- [Constant](#constants)
  - [Gunakan constants daripada angka ajaib](#use-constants-instead-of-magic-numbers)
  - [Sebaiknya gunakan enumuration classes daripada interface constants](#prefer-enumeration-classes-to-constants-interfaces)
  - [Jika tidak menggunakan enumeration classes, sebaiknya kelompokkan constants](#if-you-dont-use-enumeration-classes-group-your-constants)
- [Variabel](#variables)
  - [Sebaiknya gunakan deklarasi secara inline daripada deklarasi secara up-front](#prefer-inline-to-up-front-declarations)
  - [Jangan deklrarasi secara inline pada percabangan kondisi](#dont-declare-inline-in-optional-branches)
  - [Jangan rangkai secara berkait deklarasi up-front](#do-not-chain-up-front-declarations)
  - [Sebaiknya gunakan REF TO dbandingkan FIELD-SYMBOL](#prefer-ref-to-to-field-symbol)
- [Table](#tables)
  - [Gunakan Table Type yang sesuai](#use-the-right-table-type)
  - [Hindari DEFAULT KEY](#avoid-default-key)
  - [Sebaiknya gunakan INSERT INTO TABLE daripada APPEND TO](#prefer-insert-into-table-to-append-to)
  - [Sebaiknya gunakan LINE_EXISTS daripada READ TABLE atau LOOP AT](#prefer-line_exists-to-read-table-or-loop-at)
  - [Sebaaiknya gunakan READ TABLE daripada LOOP AT](#prefer-read-table-to-loop-at)
  - [Sebaiknya gunakan LOOP AT WHERE daripada IF bersangkar (IF dalam IF)](#prefer-loop-at-where-to-nested-if)
  - [Hindari pembacaan kepada table yang tidak perlu](#avoid-unnecessary-table-reads)
- [Strings](#strings)
  - [Gunakan ` untuk mendefenisikan literal](#use--to-define-literals)
  - [Gunakan | untuk menyusun antar teks](#use--to-assemble-text)
- [Booleans](#booleans)
  - [Gunakan Booleans dengan bijak](#use-booleans-wisely)
  - [Gunakan ABAP_BOOL untuk Booleans](#use-abap_bool-for-booleans)
  - [Gunakan ABAP_TRUE dan ABAP_FALSE untuk membandingkan](#use-abap_true-and-abap_false-for-comparisons)
  - [Gunakan XSDBOOL untuk membuat variabel Boolean](#use-xsdbool-to-set-boolean-variables)
- [Kondisi](#conditions)
  - [Usahakan membuat kondisi bernilai positif](#try-to-make-conditions-positive)
  - [Sebaiknya gunakan IS NOT dibandingkan NOT IS](#prefer-is-not-to-not-is)
  - [Pertimbangkan untuk menyederhanakan kondisi yang kompleks](#consider-decomposing-complex-conditions)
  - [Pertimbangkan untuk menyisihkan kondisi yang kompleks](#consider-extracting-complex-conditions)
- [Ifs](#ifs)
  - [Tidak boleh ada percabangan IF yang kosong](#no-empty-if-branches)
  - [Sebaiknya gunakan CASE dibandingkan ELSE IF untuk percabangan kondisi yang banyak](#prefer-case-to-else-if-for-multiple-alternative-conditions)
  - [Batasi agar kedalaman kondisi tidak terlalu dalam](#keep-the-nesting-depth-low)
- [Regular expressions](#regular-expressions)
  - [Sebaiknya gunakan methods sederhana dibandingkan regular expressions](#prefer-simpler-methods-to-regular-expressions)
  - [Sebaiknya gunakan basis checks dibandingkan regular expressions](#prefer-basis-checks-to-regular-expressions)
  - [Pertimbangkan untuk menyusun sendiri regular expression yang kompleks](#consider-assembling-complex-regular-expressions)
- [Classes](#classes)
  - [Classes: Object orientation](#classes-object-orientation)
    - [Sebaiknya gunakan objects daripada static classes](#prefer-objects-to-static-classes)
    - [Sebaiknya  gunakan komposisi daripada inheritance](#prefer-composition-to-inheritance)
    - [Jangan campur stateful dan stateless pada class yang sama](#dont-mix-stateful-and-stateless-in-the-same-class)
  - [Scope](#scope)
    - [Gunakan deklarasi Global Secara default sedangkan deklarasi local hanya pada kondisi tertentu](#global-by-default-local-only-where-appropriate)
    - [FINAL jika tidak dirancang untuk menggunakan inheritance](#final-if-not-designed-for-inheritance)
    - [Anggota class bersifat PRIVATE secara default, gunakan PROTECTED hanya jika benar-benar dibutuhkan](#members-private-by-default-protected-only-if-needed)
    - [Pertimbangkan gunakan immutable daripada getter](#consider-using-immutable-instead-of-getter)
    - [Gunakan READ-ONLY seperlunya saja](#use-read-only-sparingly)
  - [Constructors](#constructors)
    - [Sebaiknya gunakan NEW daripada CREATE OBJECT](#prefer-new-to-create-object)
    - [Jika global class menggunakan CREATE PRIVATE, biarkan CONSTRUCTOR bersifat public](#if-your-global-class-is-create-private-leave-the-constructor-public)
    - [Sebaiknya gunakan static methods daripada parameter yang bersifat opsional](#prefer-multiple-static-creation-methods-to-optional-parameters)
    - [Gunakan nama yang deskriptif untuk pembuatan methods](#use-descriptive-names-for-multiple-creation-methods)
    - [Membuat singletons hanya jika instances yang banyak tidak cocok dengan rancangan](#make-singletons-only-where-multiple-instances-dont-make-sense)
- [Methods](#methods)
  - [Pemanggilan](#calls)
    - [Jangan gunakan pemanggilan static methods melalui variabel instance ](#dont-call-static-methods-through-instance-variables)
    - [Sebaiknya gunakan pemanggila secara functional daripada secara prosedural](#prefer-functional-to-procedural-calls)
    - [Hindari RECEIVING](#omit-receiving)
    - [Hindari kata kunci opsional EXPORTING](#omit-the-optional-keyword-exporting)
    - [Hindari nama parameter pada pemanggilan dengan parameter tunggal](#omit-the-parameter-name-in-single-parameter-calls)
    - [Hindari self-reference me saat pemanggilan instance dari method](#omit-the-self-reference-me-when-calling-an-instance-method)
  - [Methods: Object orientation](#methods-object-orientation)
    - [Sebaiknya gunakan instance daripada static methods](#prefer-instance-to-static-methods)
    - [Instance methods publik seharusnya bagian dari interface](#public-instance-methods-should-be-part-of-an-interface)
  - [Jumlah Parameter](#parameter-number)
    - [Usahakan rancang dengan IMPORTING parameters sesedikit mungkin, paling tidak kurang dari tiga](#aim-for-few-importing-parameters-at-best-less-than-three)
    - [Utamakan Pisahkan methods daripada menambahkan parameter OPTIONAL](#split-methods-instead-of-adding-optional-parameters)
    - [Gunakan PREFERRED PARAMETER sejarang mungkin](#use-preferred-parameter-sparingly)
    - [RETURN, EXPORT, atau CHANGE dengan hanya menggunakan satu parameter](#return-export-or-change-exactly-one-parameter)
  - [Tipe Parameter](#parameter-types)
    - [Sebaiknya gunakan RETURNING daripada EXPORTING](#prefer-returning-to-exporting)
    - [RETURNING dengan table yang berukuran besar tidak masalah](#returning-large-tables-is-usually-okay)
    - [Gunakan salah satu antara RETURNING atau EXPORTING atau CHANGING, namun tidak mengkombinasikannya](#use-either-returning-or-exporting-or-changing-but-not-a-combination)
    - [Gunakan CHANGING sejarang mungkin, hanya jika situasi memungkinkan](#use-changing-sparingly-where-suited)
    - [Pisahkan method daripada menggunakan input parameter bertipe Boolean](#split-method-instead-of-boolean-input-parameter)
  - [Nama Parameter](#parameter-names)
    - [Sebaiknya memberi nama parameter RETURNING dengan nama RESULT](#consider-calling-the-returning-parameter-result)
  - [Inisialisasi Parameter](#parameter-initialization)
    - [Bersihkan atau overwrite referensi parameter EXPORTING](#clear-or-overwrite-exporting-reference-parameters)
      - [Perbaiki jika input dan output memungkinkan bernilai sama](#take-care-if-input-and-output-could-be-the-same)
    - [Jangan bersihkan parameter Value](#dont-clear-value-parameters)
  - [Method Body](#method-body)
    - [Lakukan satu hal, Lakukan dengan baik, hanya lakukan hal itu saja](#do-one-thing-do-it-well-do-it-only)
    - [Arahkan ke jalur yang baik dan benar atau ke error handling, namun tidak ke keduanya](#focus-on-the-happy-path-or-error-handling-but-not-both)
    - [Turun ke satu level abstraksi](#descend-one-level-of-abstraction)
    - [Jaga agar methods tetap berukuran kecil](#keep-methods-small)
  - [Alur Kontrol](#control-flow)
    - [Gagalkan dengan cepat](#fail-fast)
    - [CHECK vs. RETURN](#check-vs-return)
    - [Hindari CHECK di posisi yang lain](#avoid-check-in-other-positions)
- [Error Handling](#error-handling)
  - [Messages](#messages)
    - [Buat messages mudah untuk dicari](#make-messages-easy-to-find)
  - [Return Codes](#return-codes)
    - [Sebaiknya gunakan exceptions daripada return codes](#prefer-exceptions-to-return-codes)
    - [Jangan biarkan ada kegagalan proses terlewat](#dont-let-failures-slip-through)
  - [Exceptions](#exceptions)
    - [Exceptions dibuat untuk errors, bukan untuk kasus yang biasa saja](#exceptions-are-for-errors-not-for-regular-cases)
    - [Gunakan exceptions berbasis Class](#use-class-based-exceptions)
  - [Throwing](#throwing)
    - [Gunakan super classes-nya sendiri](#use-own-super-classes)
    - [Lempar satu jenis exception](#throw-one-type-of-exception)
    - [Gunakan sub-classes agar pemanggil dapat membedakan situasi error yang berbeda](#use-sub-classes-to-enable-callers-to-distinguish-error-situations)
    - [Lempar CX_STATIC_CHECK untuk exception yang dapat dikendalikan](#throw-cx_static_check-for-manageable-exceptions)
    - [Lempar CX_NO_CHECK untuk situasi yang biasanya tidak terkendali](#throw-cx_no_check-for-usually-unrecoverable-situations)
    - [Pertimbangkan CX_DYNAMIC_CHECK untuk exceptions yang dapat dihindari](#consider-cx_dynamic_check-for-avoidable-exceptions)
    - [Dump untuk situasi yang benar-benar tidak dapat dikembalikan seperti semula](#dump-for-totally-unrecoverable-situations)
    - [Sebaiknya gunakan RAISE EXCEPTION NEW daripada RAISE EXCEPTION TYPE](#prefer-raise-exception-new-to-raise-exception-type)
  - [Catching](#catching)
    - [Bungkus exceptions asing daripada membiarkannya masuk ke dalam kode anda](#wrap-foreign-exceptions-instead-of-letting-them-invade-your-code)
- [Komentar](#comments)
